...
class PlanilhaPrecificacao {
  private val campos: List<Campo<*, Precificacao>> =
    listOf(
      ...
      CampoNumber("ICMS Calc F") { freteICMSCalc ?: 0.00 },
      CampoNumber("ICMS F") { freteICMS ?: 0.00 },
      CampoNumber("C.Cont") { custoContabil ?: 0.00 },
      CampoNumber("P.Custo") { precoCusto ?: 0.00 },
      CampoNumber("Dif") { diferencaCusto },

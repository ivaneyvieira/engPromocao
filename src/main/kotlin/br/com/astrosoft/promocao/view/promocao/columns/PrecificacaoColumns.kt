...
object PrecificacaoColumns {
  ...
  fun Grid<Precificacao>.promocaoMvaMaOriginal() = addColumnDouble(Precificacao::mvaMaOrig) {
    this.setHeader("MVA ORG")
  }

  fun Grid<Precificacao>.promocaoNcmMa() = addColumnString(Precificacao::ncmMa) {
  ...
  fun Grid<Precificacao>.promocaoFreteIcmsCalc() = addColumnDouble(Precificacao::freteICMSCalc) {

...
object NetworkUtils {
  fun isHostReachable(hostname: String?): Boolean { //hostname ?: return false
  ...
  private fun isReachable(addr: String, openPort: Int, timeOutMillis: Int): Boolean { // Any Open port on other machine

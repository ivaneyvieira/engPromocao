...
CREATE TEMPORARY TABLE V (PRIMARY KEY (storeno, prdno, grade))
...
CREATE TEMPORARY TABLE D (PRIMARY KEY (storeno, prdno, grade))
...
CREATE TEMPORARY TABLE TT01 (PRIMARY KEY (storeno, prdno, grade))

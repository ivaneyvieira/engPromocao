...
SELECT prdno                                                                                 AS prdno,
       ...
       PD.typeno                                                                             AS typeno,
       PD.clno                                                                               AS clno,
       ROUND(IF(PD.taxno = '00', 0.00, IFNULL(PD.lucroTributado, 0)) / 100,
	     4)                                                                              AS mvap,
       P.dicm / 100                                                                          AS icmsp,
       ...
       (P.refprice / 100) - (TRUNCATE((P.cost / 100) / ((100 -
							 (((P.icm + P.pis + P.finsoc + comm + adv +
							    adm + refpdel1 + refpdel2 + refpdel3) +
							   profit) / 100)) / 100), 0) /
			     100)                                                            AS precoDif
